                ...
                <div className="row">
                    ...
                    <div className="col-sm-9">
                        <div className="konten-artikel">
                            <p></p>
                            <b>Nama   :</b>
                            <div className="judul-artikel">Mahendra Firmansyah</div>
                            <b>Alamat Cell:</b>
                            <div className="judul-artikel">Lawang</div>
                            <b>Hp :</b>
                            <div className="judul-artikel">085123456789</div>
                            <b>EMAIL :</b>
                            <div className="judul-artikel">mahendrafir69@gmail.com</div>
                        </div>
                    </div>
                </div>
            </div>
